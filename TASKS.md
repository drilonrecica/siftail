...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-040 are Done, SFT-041 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-041 — Implement disk-full degraded mode and
recovery.
