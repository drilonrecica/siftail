...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-038 — Add bounded audit storage and migration
`0004`.
