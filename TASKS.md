...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-036 are Done, SFT-037 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-037 — Close the `0.3.0` personally usable
gate.
