...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-045 are Done, SFT-046 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-046 — Add audited History export workflows.
