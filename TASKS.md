...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-046 are Done, SFT-047 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-047 — Add migration and upgrade compatibility fixtures.
