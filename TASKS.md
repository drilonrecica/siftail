...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-048 are Done, SFT-049 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-049 — Close the `0.4.0` pre-public hardening gate.
