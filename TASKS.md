...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025 is Done, SFT-026 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-026 — Add authenticated SSE transport and
control events.
