...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-047 are Done, SFT-048 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-048 — Harden recovery, failure, concurrency, and security paths.
...
[`docs/release/0.3.0-gate.md`](docs/release/0.3.0-gate.md). Neither completed
