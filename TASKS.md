...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-030 are Done, SFT-031 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-031 — Add browser Server and ingestion-token
management.
