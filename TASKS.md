...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-031 are Done, SFT-032 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-032 — Add bounded retention settings and
controls.
