...
| `0.3.0` | SFT-025–SFT-037 | Planned; SFT-025 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-025 — Implement the bounded post-commit Live
broker.
