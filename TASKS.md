...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-033 are Done, SFT-034 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-034 — Add status, readiness, and ingestion
statistics.
