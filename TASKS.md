...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-026 are Done, SFT-027 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-027 — Build the bounded Live workspace and
client lifecycle.
