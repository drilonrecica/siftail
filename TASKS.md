...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038 is Done, SFT-039 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-039 — Audit privileged actions and add the
audit view.
