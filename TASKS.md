...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-044 are Done, SFT-045 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-045 — Define bounded History export contracts
