...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-034 are Done, SFT-035 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-035 — Pin Coolify and Fluent Bit
compatibility.
