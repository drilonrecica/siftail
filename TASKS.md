...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-035 are Done, SFT-036 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-036 — Add generated configuration and guided
test ingestion.
