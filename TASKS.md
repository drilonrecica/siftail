...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-043 are Done, SFT-044 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-044 — Implement stopped-server restore with
