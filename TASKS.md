...
| `0.4.0` | SFT-038–SFT-049 | In progress; SFT-038–SFT-039 are Done, SFT-040 is Ready | Unreleased | [`docs/tasks/0.4.0.md`](docs/tasks/0.4.0.md) |
...
**Next implementable task:** SFT-040 — Add bounded diagnostics and database
checks.
