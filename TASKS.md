...
| `0.3.0` | SFT-025–SFT-037 | In progress; SFT-025–SFT-032 are Done, SFT-033 is Ready | Unreleased | [`docs/tasks/0.3.0.md`](docs/tasks/0.3.0.md) |
...
**Next implementable task:** SFT-033 — Implement bounded age and database-size
retention.
